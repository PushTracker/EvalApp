...
const routes: Routes = [
  ...
  { path: 'trial', 
    loadChildren: './modules/trial/trial.module#TrialModule', canActivate: [AuthGuardService] 
  },
  {
    path: 'eval-entry',
  ...
  { path: 'summary', 
    loadChildren: './modules/summary/summary.module#SummaryModule', canActivate: [AuthGuardService] 
  },
  { path: 'ota', 
    loadChildren: './modules/featured/featured.module#FeaturedModule', canActivate: [AuthGuardService] 
  },
  { path: 'demos', 
